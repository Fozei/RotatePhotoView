...
public class SimpleSampleActivity extends AppCompatActivity implements Observer{
    ...
    public void update(Observable observable, Object arg) {
        Log.i(TAG, "SimpleSampleActivity.update:" + "get updated");
        Bundle bundle = (Bundle)arg;
        String name = bundle.getString("name");
        float setScale = bundle.getFloat("onScale");
        if (name.equals("onScale")) {
            Log.i(TAG, "SimpleSampleActivity.update: setScale :: " + setScale);
        }
    }
